...
purge-postgres:
	-PGPASSWORD=kolibri dropdb -U learningequality "kolibri-studio" --port 5432 -h 192.168.1.111
	PGPASSWORD=kolibri createdb -U learningequality "kolibri-studio" --port 5432 -h 192.168.1.111
